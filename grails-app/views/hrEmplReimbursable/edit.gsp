...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'hrEmplReimbursable.label', default: 'hrEmplReimbursable')}" />
    ...
    <div id="edit-hrEmplReimbursable" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${hrEmplReimbursableInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${hrEmplReimbursableInstance}" var="error">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${hrEmplReimbursableInstance?.version}" />
                    <fieldset class="form">
		...
		%{--<a href="#edit-hrEmplReimbursable" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
