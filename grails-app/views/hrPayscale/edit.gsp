...
<html>
    ...
    <div id="edit-hrPayscale" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${hrPayscaleInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${hrPayscaleInstance}" var="error">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${hrPayscaleInstance?.version}" />
                    <fieldset class="form">
