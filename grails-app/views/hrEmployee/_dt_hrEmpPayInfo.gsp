...
%{--                <div class="col-xs-4">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="totalPayable" name="totalPayable" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pBasic+hrEmployeePayStructures.pDa+hrEmployeePayStructures.pHr+hrEmployeePayStructures.pConveyance+hrEmployeePayStructures.pWashingAllow+hrEmployeePayStructures.pMedicalAllowance+hrEmployeePayStructures.festivalAllowance+hrEmployeePayStructures.extraLoadAllowance+hrEmployeePayStructures.conveyanceAllowance+hrEmployeePayStructures.hillAllowance+hrEmployeePayStructures.educationAllowance}"   class="form-control" />
                    </div>
                </div>
