...
<script type="text/javascript">
    ...
    function getNetPayableSalary()
    {
        ...
        //festivalAllowance|extraLoadAllowance|conveyanceAllowance|hillAllowance|educationAllowance
        ...
        //getExpectedFieldValue("totalPayable","pBasic:pDa:pHr:pConveyance:pWashingAllow:pMedicalAllowance:festivalAllowance:extraLoadAllowance:conveyanceAllowance:hillAllowance:educationAllowance");
            ...
            <td class="captionSpaceFirst">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label for="payScaleId"><g:message code="hrEmployee.payScaleId.label" default="Pay Scale" /></label>
                        <g:if test="${hrEmployeePayStructures?.payScaleId == null}">
                            <g:select id="payScaleId" name="payScaleId" optionKey="id" optionValue="gradeNo" from="${hrms.HrPayscale.list()}" value="" noSelection="['':'-Select One-']"  class="form-control"/>%{--onchange="getSlabNo();"--}%
                        </g:if>
                        <g:else>
                            <g:select id="payScaleId" name="payScaleId" optionKey="id" optionValue="gradeNo" from="${hrms.HrPayscale.list()}" value="${hrEmployeePayStructures?.payScaleId}"  class="form-control"/>%{--onchange="getSlabNo();"--}%
                        </g:else>
                    </div>
                </div>
                %{--<div class="col-xs-6">
            ...
            <td class="captionSpaceFirst">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="consultantRemuneration" name="consultantRemuneration" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.consultantRemuneration}"   onchange="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
            ...
            <td class="captionSpaceFirst">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="pBasic" name="pBasic" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pBasic}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                       ...
                       %{-- <g:textField id="pDa" name="pDa" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pDa}" readonly="readonly" onchange="getNetPayableSalary();" class="form-control" />--}%
                        <g:textField id="pDa" name="pDa" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pDa}"  onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="pConveyance" name="pConveyance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pConveyance}"  onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="pHr" name="pHr" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pHr}"  onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                      ...
                      %{--  <g:textField id="pWashingAllow" name="pWashingAllow" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pWashingAllow}"   readonly="readonly" onchange="getNetPayableSalary();" class="form-control" />--}%
                        <g:textField id="pWashingAllow" name="pWashingAllow" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pWashingAllow}"   onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                      ...
                      %{--  <g:textField id="pMedicalAllowance" name="pMedicalAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pMedicalAllowance}" readonly="readonly" onchange="getNetPayableSalary();" class="form-control" />--}%
                        <g:textField id="pMedicalAllowance" name="pMedicalAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.pMedicalAllowance}"  onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="festivalAllowance" name="festivalAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.festivalAllowance}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="extraLoadAllowance" name="extraLoadAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.extraLoadAllowance}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="conveyanceAllowance" name="conveyanceAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.conveyanceAllowance}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="hillAllowance" name="hillAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.hillAllowance}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="educationAllowance" name="educationAllowance" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.educationAllowance}" onchange="getNetPayableSalary();" onkeyup="getNetPayableSalary();" class="form-control" />
                    </div>
                </div>
...
%{--                <div class="col-xs-4">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="totalPayable" name="totalPayable" value="${hrEmployeePayStructures==null?0:+(hrEmployeePayStructures.pBasic==null?0:hrEmployeePayStructures.pBasic)+(hrEmployeePayStructures.pDa==null?0:hrEmployeePayStructures.pDa)+(hrEmployeePayStructures.pHr==null?0:hrEmployeePayStructures.pHr)+(hrEmployeePayStructures.pConveyance==null?0:hrEmployeePayStructures.pConveyance)+(hrEmployeePayStructures.pWashingAllow==null?0:hrEmployeePayStructures.pWashingAllow)+(hrEmployeePayStructures.pMedicalAllowance==null?0:hrEmployeePayStructures.pMedicalAllowance)+(hrEmployeePayStructures.festivalAllowance==null?0:hrEmployeePayStructures.festivalAllowance)+(hrEmployeePayStructures.extraLoadAllowance==null?0:hrEmployeePayStructures.extraLoadAllowance)+(hrEmployeePayStructures.conveyanceAllowance==null?0:hrEmployeePayStructures.conveyanceAllowance)+(hrEmployeePayStructures.hillAllowance==null?0:hrEmployeePayStructures.hillAllowance)+(hrEmployeePayStructures.educationAllowance==null?0:hrEmployeePayStructures.educationAllowance)}"   class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                       ...
                       %{-- <g:textField id="totalOtherPayable" name="totalOtherPayable" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.spAllowance+hrEmployeePayStructures.spDaAllowance+hrEmployeePayStructures.addSpAllowance+hrEmployeePayStructures.spRetro+hrEmployeePayStructures.retroPf}" readonly="readonly" class="form-control" />--}%
                        <g:textField id="totalOtherPayable" name="totalOtherPayable" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.spAllowance+hrEmployeePayStructures.spDaAllowance+hrEmployeePayStructures.addSpAllowance+hrEmployeePayStructures.spRetro+hrEmployeePayStructures.retroPf}"   class="form-control" />
                    </div>
                </div>
            ...
            <td class="captionSpaceFirst">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="totalDeduction" name="totalDeduction" value="${hrEmployeePayStructures==null?0:hrEmployeePayStructures.dLoanSalary+hrEmployeePayStructures.dLoanPf+hrEmployeePayStructures.dOwnPf+hrEmployeePayStructures.dOthers+hrEmployeePayStructures.dIncomeTax+hrEmployeePayStructures.dGroupInsurance}" readonly="readonly" class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <g:textField id="netMonthlyPayable" name="netMonthlyPayable" value="${(hrEmployeePayStructures==null?0:hrEmployeePayStructures.pBasic+hrEmployeePayStructures.consultantRemuneration+hrEmployeePayStructures.pDa+hrEmployeePayStructures.pHr+hrEmployeePayStructures.pConveyance+hrEmployeePayStructures.pWashingAllow+hrEmployeePayStructures.pMedicalAllowance+hrEmployeePayStructures.spAllowance+hrEmployeePayStructures.spDaAllowance+hrEmployeePayStructures.addSpAllowance+hrEmployeePayStructures.spRetro+hrEmployeePayStructures.retroPf) - (hrEmployeePayStructures==null?0:hrEmployeePayStructures.dLoanSalary+hrEmployeePayStructures.dLoanPf+hrEmployeePayStructures.dOwnPf+hrEmployeePayStructures.dOthers+hrEmployeePayStructures.dIncomeTax+hrEmployeePayStructures.dGroupInsurance)}" readonly="readonly" class="form-control" />
                    </div>
                </div>
...
<div style="width: 100%; height: 100%; background: #fff; padding: 1%;border: 1px solid #ccc;">
            ...
            <td class="captionSpaceFirst">
                <div class="col-xs-10">
                    <div class="form-group">
                        ...
                        <g:textArea id="payrollRemarks" name="payrollRemarks" value="${hrEmployeePayStructures?.payrollRemarks}"  class="form-control" />
                    </div>
                </div>
            </td>
        </tr>
    ...
    <g:hiddenField name='hrEmployeePayStructures.id' id="employeesPayrollId" value='${hrEmployeePayStructures==null?0:hrEmployeePayStructures?.id}'/>
