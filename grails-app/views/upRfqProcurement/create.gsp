...
//                alert(schemeInfoId);
    ...
    <div id="create-upDirectProcurement" class="content scaffold-create" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${upRfqProcurementInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${upRfqProcurementInstance}" var="error">
    ...
    %{----}%
		%{--<a href="#create-upRfqProcurement" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		%{--<div class="nav" role="navigation">--}%
			...
			%{--</ul>--}%
		%{--</div>--}%
		%{--<div id="create-upRfqProcurement" class="content scaffold-create" role="main">--}%
