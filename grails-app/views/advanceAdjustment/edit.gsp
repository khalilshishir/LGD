...
<p align="right" style="color:#666; font-size: 15px; padding-right: 5px; margin-top: 10px;">
    ...
    |
    <a style="color:#666; font-size: 15px;" href="#"><g:link class="list" action="list"><g:message code="default.list.label/" default="অগ্রিম সমন্বয় লিস্ট" args="[entityName]" /></g:link></a>
    |
    <a style="color:#666; font-size: 15px;" href="#"><g:link class="create" action="create"><g:message code="default.new.label/" default="নতুন অগ্রিম সমন্বয়" args="[entityName]" /></g:link></a>
</p>
<div id="edit-labourAppointmentInfo" class="content scaffold-edit" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><g:message code="default.create.label/" default="এডিট - অগ্রিম সমন্বয়" args="[entityName]" /></h3>
        ...
        <div class="panel-body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${advanceAdjustmentInstance?.version}" />
