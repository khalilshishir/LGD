    ...
    <div class="form-group">
        <div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'STAKEHOLDER_ID', 'error')} ">
            <label for="STAKEHOLDER_ID">
                <g:message code="ASSET_DISTRIBUTION.STAKEHOLDER_ID.label" default="Current Stakeholder Name"/>

            </label>
            <g:select disabled=""  id="STAKEHOLDER_ID" name="STAKEHOLDER_ID.id" from="${fixedAsset.STAKEHOLDER.list()}"
...
<div class="col-xs-6">
    <div class="form-group">
        <div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'STAKEHOLDER_ID', 'error')} ">
            <label for="STAKEHOLDER_ID">
                <g:message code="ASSET_DISTRIBUTION.STAKEHOLDER_ID.label" default="New Stakeholder Name"/>
...
<div class="col-xs-6">
    <div class="form-group">
        <div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'ASSET_BOOK_ID', 'error')} ">
            ...
            <g:select disabled="" id="ASSET_BOOK_ID" name="ASSET_BOOK_ID.id" from="${fixedAsset.ASSET_BOOK.list()}" optionKey="id"
    ...
    <div class="form-group">
        <div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'LOCATION_ID', 'error')} ">
            <label for="LOCATION_ID">
                <g:message code="ASSET_DISTRIBUTION.LOCATION_ID.label" default="Current Location"/>

            </label>
            <g:select disabled="" id="LOCATION_ID" name="LOCATION_ID.id" from="${fixedAsset.LOCATION.list()}" optionKey="id"
...
<div class="col-xs-6">
    <div class="form-group">
        <div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'LOCATION_ID', 'error')} ">
            <label for="LOCATION_ID">
                <g:message code="ASSET_DISTRIBUTION.LOCATION_ID.label" default="New Location"/>
...
<div class="col-xs-6">
    <div class="form-group">
        %{--<div class="fieldcontain ${hasErrors(bean: ASSET_DISTRIBUTIONInstance, field: 'ASSET_BOOK_ID', 'error')} ">--}%
            ...
            <g:select style="visibility: hidden;" id="ASSET_BOOK_ID" name="ASSET_BOOK_ID.id" from="${fixedAsset.ASSET_BOOK.list()}" optionKey="id"
                      value="${ASSET_DISTRIBUTIONInstance?.ASSET_BOOK_ID?.id}" class="many-to-one form-control"
                      noSelection="['': '-Select-']"/>
            <g:select style="visibility: hidden;"  id="OLD_STAKEHOLDER_ID" name="OLD_STAKEHOLDER_ID.id" from="${fixedAsset.STAKEHOLDER.list()}"
                      optionKey="id" value="${ASSET_DISTRIBUTIONInstance?.STAKEHOLDER_ID?.id}" class="many-to-one form-control"
                      noSelection="['': '-Select-']"/>
            <g:select style="visibility: hidden;" id="OLD_LOCATION_ID" name="OLD_LOCATION_ID.id" from="${fixedAsset.LOCATION.list()}" optionKey="id"
                      value="${ASSET_DISTRIBUTIONInstance?.LOCATION_ID?.id}" class="many-to-one form-control"
                      noSelection="['': '-Select-']"/>
        %{--</div>--}%
    </div>
