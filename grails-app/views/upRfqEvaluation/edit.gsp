...
<div id="edit-up_Proc_Master" class="content scaffold-edit" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><g:message code="default.edit.label/" default="এডিট - ইউপি দরপত্র মূল্যায়ন প্রতিবেদন" args="[entityName]"/></h3>
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            <g:hasErrors bean="${upRfqEvaluationInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${upRfqEvaluationInstance}" var="error">
        ...
        <div class="panel-body">
            <g:form method="post">
                ...
                <g:hiddenField name="version" value="${upRfqEvaluationInstance?.version}"/>
                <fieldset class="form" id="upRfqEvaluationForm" name="upRfqEvaluationForm">
