...
<div id="list-upOtmEvaluation" class="content scaffold-list" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><g:message code="default.list.label/" default="ইউপি উন্মুক্ত দরপত্র মূল্যায়ন প্রতিবেদন লিস্ট" args="[entityName]" /></h3>
        </div>
    </div>
    ...
    <table id="example" class="dataListTable table table-bordered table-striped table-hover table-condensed">
        ...
        <tr>
            ...
            <g:sortableColumn property="EVALUATION_DATE" title="${message(code: 'upOtmEvaluation.EVALUATION_DATE.label', default: 'দরপত্র মূল্যায়ন তারিখ')}" />
        ...
        <g:each in="${upOtmEvaluationInstanceList}" status="i" var="upOtmEvaluationInstance">
            <tr>
                ...
                <td><g:link action="show" id="${upOtmEvaluationInstance.id}">${fieldValue(bean: upOtmEvaluationInstance, field: "schemeInfo.NAME")}</g:link></td>
