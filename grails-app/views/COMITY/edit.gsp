...
<html>
	...
	<body>
		%{--<a href="#edit-COMITY" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-COMITY" class="content scaffold-edit" role="main">
			...
			<g:form method="post" enctype="multipart/form-data">
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save btn-primary btn-sm" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
