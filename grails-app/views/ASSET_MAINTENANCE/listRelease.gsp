...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'ASSET_MAINTENANCE.label', default: 'Asset Release')}" />
    ...
    <table id="example" class="dataListTable table table-bordered table-striped table-hover table-condensed">
        ...
        <g:each in="${ASSET_MAINTENANCEInstanceList}" status="i" var="ASSET_MAINTENANCEInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td> <a href="${request.contextPath}/ASSET_MAINTENANCE/release/${ASSET_MAINTENANCEInstance?.id}" class="btn btn-success">Release</a></td>
            </tr>
        </g:each>
        </tbody>
    </table>
