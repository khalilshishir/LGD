...
<html>
	...
	<body>
		%{--<a href="#create-ASSET_MAINTENANCE" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="create-ASSET_MAINTENANCE" class="content scaffold-create" role="main">
