...
<div class="col-xs-6">
    <div class="form-group">
        ...
        <g:textField id="PROCUREMENT_TYPE" name="PROCUREMENT_TYPE.id" readonly="" value="${otmIFQDetailsByProcurementMaster?.GRANTED_AMOUNT[0]}" class="form-control" />
    </div>
</div>
<div class="col-xs-6">
    <div class="form-group">
...
<div class="col-xs-6">
    <div class="form-group">
        <label for="IFT_DATE"><g:message code="upOtmOpeningSheet.UP_PROC_MASTER.label" default="দরপত্র তৈরির তারিখ"/></label>
...
<div class="col-xs-6">
    <div class="form-group">
        <label for="IFT_NUMBER"><g:message code="upOtmOpeningSheet.UP_PROC_MASTER.label" default="দরপত্র আহ্বান নাম্বার"/></label>
...
<div class="col-xs-6">
    <div class="form-group">
        <label for="SUB_LAST_DATE"><g:message code="upOtmOpeningSheet.UP_PROC_MASTER.label" default="দরপত্র দাখিলের শেষ তারিখ"/></label>
