...
<div id="edit-masterRoleSalary" class="content scaffold-edit" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><g:message code="default.edit.label/" default="এডিট - মাস্টার-রোলে মজুরী " args="[entityName]"/></h3>
        ...
        <div class="panel-body">
            <g:form method="post">
                ...
                <g:hiddenField name="version" value="${masterRoleSalaryInstance?.version}"/>

                <fieldset class="form" id="masterRoleSalaryForm" name="masterRoleSalaryForm">
