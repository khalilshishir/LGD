...
<html>
    ...
    <div id="edit-hrLeave" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${hrLeaveInstance?.version}" />
                    <fieldset class="form">
    ...
    %{--
		...
		<a href="#edit-hrLeave" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
